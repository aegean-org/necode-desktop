...
const icons = {
  ...
  "arrow-right": {
    viewBox: "0 0 16 16",
    body: `<path d="M3 8H13M9.5 4.5L13 8L9.5 11.5" stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"/>`,
  },
  help: {
    viewBox: "0 0 16 16",
...
function requireIcon(name: IconName) {
  if (Object.hasOwn(icons, name)) return name
