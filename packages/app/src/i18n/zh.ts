...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 NeCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "NeCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 NeCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "NeCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 NeCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 NeCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 NeCode 服务器。",
  ...
  "toast.update.description": "NeCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 NeCode 团队",
  "error.page.report.discord": "在 Discord 上",
  "error.page.report.feedback": "通过反馈入口",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: NeCode 暂不支持 MCP 认证。',
  ...
  "home.tasks.search.placeholder": "搜索任务或会话",
  "home.tasks.search.tasks": "任务",
  "home.tasks.search.noResults": "未找到与 {{query}} 相关的任务",
  "home.tasks.title": "任务",
  ...
  "home.tasks.group.done": "已完成",
  "home.tasks.status.needsAction": "需要处理",
  "home.tasks.status.running": "进行中",
  "home.tasks.status.ready": "就绪",
  "home.tasks.status.done": "已完成",
  "home.tasks.meta.permission": "权限",
  "home.tasks.meta.question": "问题",
  "home.tasks.meta.todo": "已完成 {{done}}/{{total}}",
  "home.tasks.detail.title": "任务详情",
  "home.tasks.detail.emptyTitle": "未选择任务",
  "home.tasks.detail.emptyDescription": "悬停或聚焦任务后，可在这里查看当前工作流状态。",
  "home.tasks.detail.emptyProjectTitle": "{{project}} 已就绪",
  "home.tasks.detail.emptyProjectDescription": "新建第一个会话后，这个项目会进入工作流任务列表。",
  "home.tasks.detail.emptyProjectPath": "项目路径",
  "home.tasks.detail.status": "状态",
  "home.tasks.detail.project": "项目",
  "home.tasks.detail.updated": "更新",
  "home.tasks.detail.progress": "进度",
  "home.tasks.detail.noProgress": "无待办",
  "home.tasks.detail.signals": "信号",
  "home.tasks.detail.noSignals": "暂无待处理信号",
  "home.tasks.detail.context": "上下文",
  "home.tasks.detail.directory": "目录",
  "home.tasks.detail.session": "会话",
  "home.tasks.detail.open": "打开任务",

  "session.tab.session": "会话",
  "session.tab.review": "审查",
  "session.tab.context": "上下文",
  "session.workflow.title": "会话导航",
  "session.workflow.empty": "当前目录暂无会话",
  ...
  "sidebar.gettingStarted.line1": "NeCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 NeCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 NeCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 NeCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 NeCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 NeCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 NeCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 NeCode。",
  ...
  "settings.plugins.action.install": "安装插件",
  "settings.plugins.action.remove": "移除",
  "settings.plugins.search.placeholder": "搜索插件",
  "settings.plugins.section.builtin": "内置生产力插件",
  "settings.plugins.section.installed": "已安装插件",
  "settings.plugins.section.system": "系统组件",
  "settings.plugins.desktopOnly": "插件管理仅在桌面端可用",
  "settings.plugins.noProject": "打开项目后管理插件",
  ...
  "settings.plugins.source.file": "本地路径",
  ...
  "settings.plugins.dialog.install.error.npm": "请输入 npm 包名",
  "settings.plugins.dialog.install.error.local": "请选择本地插件目录或入口文件",
  "settings.plugins.dialog.install.error.desktop": "选择本地插件需要使用桌面端",
  "settings.plugins.dialog.remove.title": "移除插件",
  "settings.plugins.dialog.remove.description": "从{{scope}}移除“{{name}}”？",
  "settings.plugins.dialog.remove.action": "移除",
  "settings.plugins.detail.source": "来源",
  "settings.plugins.detail.scope": "范围",
  "settings.plugins.detail.key": "插件键",
  "settings.plugins.detail.spec": "安装配置",
  "settings.plugins.detail.target": "解析路径",
  "settings.plugins.detail.errorStage": "失败阶段",
  "settings.plugins.detail.errorMessage": "错误信息",
  "settings.plugins.detail.capabilities": "能力",
  "settings.plugins.detail.tools": "工具",
  "settings.plugins.detail.skills": "技能",
  ...
  "settings.mcp.scope.builtin": "内置",
  "settings.mcp.overridden.project": "已被项目配置覆盖",
  "settings.mcp.overridden.global": "已被全局配置覆盖",
  "settings.mcp.addMethod.title": "添加 MCP",
  "settings.mcp.addMethod.import": "粘贴 MCP 配置",
  "settings.mcp.addMethod.manual": "手动配置",
  "settings.mcp.import.title": "粘贴 MCP 配置",
  "settings.mcp.import.config": "MCP 配置",
  "settings.mcp.import.placeholder": "粘贴一个 JSON 或 JSONC 格式的 MCP 服务",
  "settings.mcp.import.scope": "作用域",
  "settings.mcp.import.check": "检查配置",
  "settings.mcp.import.error.invalidJsonc": "请输入有效的 JSON 或 JSONC",
  "settings.mcp.import.error.singleEntry": "请仅粘贴一个 MCP 服务。",
  "settings.mcp.import.error.invalidEntry": "请输入有效的本地或远程 MCP 服务配置",
  "settings.mcp.import.error.unsupportedField": "请先移除不支持的字段再导入",
  "settings.mcp.dialog.addTitle": "新增 MCP",
  "settings.mcp.dialog.editTitle": "编辑 MCP",
  "settings.mcp.dialog.remove.title": "移除 MCP",
  "settings.mcp.dialog.remove.description": "从{{scope}}移除“{{name}}”？",
  "settings.mcp.dialog.remove.action": "移除",
  "settings.mcp.dialog.field.name": "名称",
  "settings.mcp.dialog.field.scope": "作用域",
  "settings.mcp.dialog.field.type": "类型",
  "settings.mcp.dialog.field.timeout": "超时时间",
  "settings.mcp.dialog.field.timeoutPlaceholder": "毫秒",
  "settings.mcp.dialog.field.enabled": "启用",
  "settings.mcp.dialog.scope.project": "当前项目",
  "settings.mcp.dialog.scope.global": "全局",
  "settings.mcp.dialog.scope.builtin": "内置",
  "settings.mcp.dialog.type.local": "本地",
  "settings.mcp.dialog.type.remote": "远程",
  "settings.mcp.dialog.local.command": "命令",
  "settings.mcp.dialog.local.executable": "可执行命令",
  "settings.mcp.dialog.local.argument": "参数 {{index}}",
  "settings.mcp.dialog.local.addArgument": "添加参数",
  "settings.mcp.dialog.local.removeCommand": "移除命令行 {{row}}",
  "settings.mcp.dialog.local.cwd": "工作目录",
  "settings.mcp.dialog.local.cwdPlaceholder": "可选工作目录",
  "settings.mcp.dialog.local.environment": "环境变量",
  "settings.mcp.dialog.local.environmentKey": "变量名",
  "settings.mcp.dialog.local.environmentValue": "值",
  "settings.mcp.dialog.remote.url": "URL",
  "settings.mcp.dialog.remote.urlPlaceholder": "https://example.com/mcp",
  "settings.mcp.dialog.remote.header": "请求头",
  "settings.mcp.dialog.remote.headerKey": "请求头名称",
  "settings.mcp.dialog.remote.headerValue": "请求头值",
  "settings.mcp.dialog.oauth.label": "OAuth",
  "settings.mcp.dialog.oauth.auto": "自动",
  "settings.mcp.dialog.oauth.disabled": "禁用",
  "settings.mcp.dialog.oauth.explicit": "指定客户端",
  "settings.mcp.dialog.oauth.clientId": "客户端 ID",
  "settings.mcp.dialog.oauth.clientSecret": "客户端密钥",
  "settings.mcp.dialog.oauth.scope": "授权范围",
  "settings.mcp.dialog.oauth.callbackPort": "回调端口",
  "settings.mcp.dialog.oauth.redirectUri": "重定向 URI",
  "settings.mcp.dialog.keyValue.key": "{{label}}键 {{row}}",
  "settings.mcp.dialog.keyValue.value": "{{label}}值 {{row}}",
  "settings.mcp.dialog.keyValue.add": "添加{{label}}",
  "settings.mcp.dialog.keyValue.remove": "移除{{label}}行 {{row}}",
  "settings.mcp.dialog.typeSwitch.message": "切换类型将清除当前类型字段",
  "settings.mcp.dialog.typeSwitch.cancel": "取消切换",
  "settings.mcp.dialog.typeSwitch.confirm": "继续切换",
  "settings.mcp.dialog.error.required": "此字段为必填项",
  "settings.mcp.dialog.error.reserved": "此名称已保留",
  "settings.mcp.dialog.error.duplicate": "此名称已存在",
  "settings.mcp.dialog.error.invalidName": "仅可使用小写字母、数字、下划线或连字符",
  "settings.mcp.dialog.error.positiveInteger": "请输入正整数",
  "settings.mcp.dialog.error.url": "请输入 HTTP 或 HTTPS URL",
  "settings.mcp.dialog.error.value": "请输入有效值",
  "settings.mcp.dialog.error.incompleteKeyValue": "键和值均为必填项",
  "settings.mcp.dialog.error.duplicateKey": "键不得重复",
  "settings.rag.title": "文献",
  "settings.rag.allDocuments": "全部文献",
  "settings.rag.allDocumentsDescription": "搜索全部已索引文献",
  "settings.rag.action.files": "导入文件",
  "settings.rag.action.folder": "导入文件夹",
  "settings.rag.action.importing": "导入中...",
  "settings.rag.dialog.chooseFiles": "选择文献文件",
  "settings.rag.dialog.chooseFolder": "选择文献文件夹",
  "settings.rag.metric.documents": "已索引文献",
  "settings.rag.metric.chunks": "文本片段",
  "settings.rag.section.index": "索引",
  "settings.rag.section.documents": "已索引文献",
  "settings.rag.storePath": "索引位置",
  "settings.rag.empty": "暂无已索引文献",
  "settings.rag.toast.imported.title": "文献已导入",
  "settings.rag.toast.imported.description": "已将 {{count}} 个路径导入本地索引。",
  "settings.rag.toast.desktopOnly.title": "需要桌面端",
  "settings.rag.toast.desktopOnly.description": "本地文献导入仅在桌面端可用。",
  ...
  "settings.skills.action.install": "安装 Skill",
  "settings.skills.action.remove": "卸载",
  "settings.skills.scope.local": "当前项目",
  "settings.skills.scope.global": "全局",
  "settings.skills.source.builtin": "内置",
  "settings.skills.source.managed": "已安装",
  "settings.skills.source.plugin": "插件提供",
  "settings.skills.source.external": "外部发现",
  "settings.skills.source.configured": "自动发现",
  "settings.skills.source.url": "URL 缓存",
  ...
  "settings.skills.dialog.install.local.placeholder": "选择或输入本地目录",
  ...
  "settings.skills.toast.installed.title": "Skill 安装完成",
  "settings.skills.toast.installed.description": "已安装 {{count}} 个 Skill，并显示在列表顶部。",
  "settings.skills.toast.installed.unchanged": "Skill 已是最新状态，列表已刷新。",
  "settings.skills.section.recent": "刚刚安装（{{count}}）",
  "settings.skills.section.other": "其他 Skill",
  "settings.skills.dialog.install.replace": "确认替换",
  "settings.skills.dialog.install.conflict": "{{name}} 已从 {{source}} 安装。确认后将使用新来源替换。",
  "settings.skills.dialog.install.error.url": "请输入 GitHub 仓库或 Skill 源地址",
  "settings.skills.dialog.install.error.local": "请选择或输入 Skill 目录",
  "settings.skills.dialog.install.error.desktop": "目录选择器仅在 NeCode Desktop 中可用",
  "settings.skills.dialog.remove.title": "卸载 Skill",
  "settings.skills.dialog.remove.description":
    "确定删除独立安装的 Skill“{{name}}”吗？插件提供和自动发现的 Skill 不能在这里删除。",
