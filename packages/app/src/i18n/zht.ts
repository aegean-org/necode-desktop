...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NeCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 NeCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "NeCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 NeCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 NeCode 中使用 {{provider}} 模型。",
  ...
  "prompt.placeholder.design": "問點什麼，輸入 / 查看命令，輸入 @ 新增上下文…",
  ...
  "dialog.server.description": "切換此應用程式連線的 NeCode 伺服器。",
  ...
  "toast.update.description": "NeCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 NeCode 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: NeCode 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "NeCode 提供免費模型，你可以立即開始使用。",
  ...
  "project.action.pin": "置頂專案",
  "project.action.openInExplorer": "在檔案總管中開啟",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 NeCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 NeCode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 NeCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 NeCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 NeCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 NeCode 啟動時自動檢查更新",
  ...
  "settings.mcp.action.add": "新增 MCP",
  "settings.mcp.action.edit": "編輯",
  "settings.mcp.action.remove": "移除",
  "settings.mcp.scope.project": "目前專案",
  "settings.mcp.scope.global": "全域",
  "settings.mcp.scope.builtin": "內建",
  "settings.mcp.overridden.project": "已被專案設定覆蓋",
  "settings.mcp.overridden.global": "已被全域設定覆蓋",
  "settings.mcp.addMethod.title": "新增 MCP",
  "settings.mcp.addMethod.import": "貼上 MCP 設定",
  "settings.mcp.addMethod.manual": "手動設定",
  "settings.mcp.import.title": "貼上 MCP 設定",
  "settings.mcp.import.config": "MCP 設定",
  "settings.mcp.import.placeholder": "貼上一個 JSON 或 JSONC 格式的 MCP 服務",
  "settings.mcp.import.scope": "範圍",
  "settings.mcp.import.check": "檢查設定",
  "settings.mcp.import.error.invalidJsonc": "請輸入有效的 JSON 或 JSONC",
  "settings.mcp.import.error.singleEntry": "請只貼上一個 MCP 服務。",
  "settings.mcp.import.error.invalidEntry": "請輸入有效的本機或遠端 MCP 服務設定",
  "settings.mcp.import.error.unsupportedField": "請先移除不支援的欄位再匯入",
  "settings.mcp.dialog.addTitle": "新增 MCP",
  "settings.mcp.dialog.editTitle": "編輯 MCP",
  "settings.mcp.dialog.remove.title": "移除 MCP",
  "settings.mcp.dialog.remove.description": "從{{scope}}移除「{{name}}」？",
  "settings.mcp.dialog.remove.action": "移除",
  "settings.mcp.dialog.field.name": "名稱",
  "settings.mcp.dialog.field.scope": "作用域",
  "settings.mcp.dialog.field.type": "類型",
  "settings.mcp.dialog.field.timeout": "逾時時間",
  "settings.mcp.dialog.field.timeoutPlaceholder": "毫秒",
  "settings.mcp.dialog.field.enabled": "啟用",
  "settings.mcp.dialog.scope.project": "目前專案",
  "settings.mcp.dialog.scope.global": "全域",
  "settings.mcp.dialog.scope.builtin": "內建",
  "settings.mcp.dialog.type.local": "本機",
  "settings.mcp.dialog.type.remote": "遠端",
  "settings.mcp.dialog.local.command": "命令",
  "settings.mcp.dialog.local.executable": "可執行命令",
  "settings.mcp.dialog.local.argument": "參數 {{index}}",
  "settings.mcp.dialog.local.addArgument": "新增參數",
  "settings.mcp.dialog.local.removeCommand": "移除命令列 {{row}}",
  "settings.mcp.dialog.local.cwd": "工作目錄",
  "settings.mcp.dialog.local.cwdPlaceholder": "選填工作目錄",
  "settings.mcp.dialog.local.environment": "環境變數",
  "settings.mcp.dialog.local.environmentKey": "變數名稱",
  ...
  "settings.mcp.dialog.remote.header": "要求標頭",
  "settings.mcp.dialog.remote.headerKey": "標頭名稱",
  "settings.mcp.dialog.remote.headerValue": "標頭值",
  "settings.mcp.dialog.oauth.label": "OAuth",
  "settings.mcp.dialog.oauth.auto": "自動",
  "settings.mcp.dialog.oauth.disabled": "停用",
  "settings.mcp.dialog.oauth.explicit": "指定用戶端",
  "settings.mcp.dialog.oauth.clientId": "用戶端 ID",
  "settings.mcp.dialog.oauth.clientSecret": "用戶端密鑰",
  "settings.mcp.dialog.oauth.scope": "授權範圍",
  "settings.mcp.dialog.oauth.callbackPort": "回呼連接埠",
  "settings.mcp.dialog.oauth.redirectUri": "重新導向 URI",
  "settings.mcp.dialog.keyValue.key": "{{label}}鍵 {{row}}",
  "settings.mcp.dialog.keyValue.value": "{{label}}值 {{row}}",
  "settings.mcp.dialog.keyValue.add": "新增{{label}}",
  "settings.mcp.dialog.keyValue.remove": "移除{{label}}列 {{row}}",
  "settings.mcp.dialog.typeSwitch.message": "切換類型將清除目前類型欄位",
  "settings.mcp.dialog.typeSwitch.cancel": "取消切換",
  "settings.mcp.dialog.typeSwitch.confirm": "繼續切換",
  "settings.mcp.dialog.error.required": "此欄位為必填",
  "settings.mcp.dialog.error.reserved": "此名稱已保留",
  "settings.mcp.dialog.error.duplicate": "此名稱已存在",
  "settings.mcp.dialog.error.invalidName": "僅可使用小寫字母、數字、底線或連字號",
  "settings.mcp.dialog.error.positiveInteger": "請輸入正整數",
  "settings.mcp.dialog.error.url": "請輸入 HTTP 或 HTTPS URL",
  "settings.mcp.dialog.error.value": "請輸入有效值",
  ...
  "settings.skills.action.install": "安裝 Skill",
  "settings.skills.action.remove": "解除安裝",
  "settings.skills.scope.local": "目前專案",
  "settings.skills.scope.global": "全域",
  "settings.skills.source.builtin": "內建",
  "settings.skills.source.managed": "已安裝",
  "settings.skills.source.plugin": "外掛提供",
  "settings.skills.source.external": "外部探索",
  "settings.skills.source.configured": "自動探索",
  "settings.skills.source.url": "URL 快取",
  "settings.skills.dialog.install.title": "安裝 Skill",
  "settings.skills.dialog.install.method.url": "GitHub / URL",
  "settings.skills.dialog.install.method.local": "本機目錄",
  "settings.skills.dialog.install.url.label": "GitHub 儲存庫或 Skill 來源網址",
  "settings.skills.dialog.install.url.placeholder": "https://github.com/owner/repository",
  "settings.skills.dialog.install.local.label": "Skill 目錄",
  "settings.skills.dialog.install.local.placeholder": "選擇或輸入本機目錄",
  "settings.skills.dialog.install.local.choose": "選擇目錄",
  "settings.skills.dialog.install.scope": "安裝範圍",
  "settings.skills.dialog.install.action": "安裝",
  "settings.skills.dialog.install.installing": "安裝中…",
  "settings.skills.dialog.install.progress": "正在下載並安裝，較大的儲存庫可能需要一些時間。",
  "settings.skills.toast.installed.title": "Skill 安裝完成",
  "settings.skills.toast.installed.description": "已安裝 {{count}} 個 Skill，並顯示在清單頂端。",
  "settings.skills.toast.installed.unchanged": "Skill 已是最新狀態，清單已重新整理。",
  "settings.skills.section.recent": "剛剛安裝（{{count}}）",
  "settings.skills.section.other": "其他 Skill",
  "settings.skills.dialog.install.replace": "確認取代",
  "settings.skills.dialog.install.conflict": "{{name}} 已從 {{source}} 安裝。確認後將以新來源取代。",
  "settings.skills.dialog.install.error.url": "請輸入 GitHub 儲存庫或 Skill 來源網址",
  "settings.skills.dialog.install.error.local": "請選擇或輸入 Skill 目錄",
  "settings.skills.dialog.install.error.desktop": "目錄選擇器僅能在 NeCode Desktop 使用",
  "settings.skills.dialog.remove.title": "解除安裝 Skill",
  "settings.skills.dialog.remove.description":
    "確定移除獨立安裝的 Skill「{{name}}」嗎？外掛提供與自動探索的 Skill 無法在這裡移除。",
