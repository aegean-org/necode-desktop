export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NeCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NeCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NeCode.",
  ...
  "dialog.server.description": "Switch which NeCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "NeCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking NeCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking NeCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating NeCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating NeCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update NeCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update NeCode",
  "wsl.onboarding.opencodeReadyIn": "NeCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NeCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install NeCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install NeCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NeCode.",
  ...
  "toast.update.description": "A new version of NeCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NeCode team",
  "error.page.report.discord": "on Discord",
  "error.page.report.feedback": "through feedback",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NeCode does not support MCP authentication yet.',
  ...
  "home.tasks.search.placeholder": "Search tasks or sessions",
  "home.tasks.search.tasks": "Tasks",
  "home.tasks.search.noResults": "No tasks found for {{query}}",
  "home.tasks.title": "Tasks",
  "home.tasks.workflow": "Workflow",
  "home.tasks.overview": "Task overview",
  "home.tasks.empty": "No tasks found",
  "home.tasks.empty.archived": "No archived sessions",
  "home.tasks.empty.archivedDescription": "Archived sessions will appear here.",
  "home.tasks.empty.projectTitle": "No tasks yet in {{project}}",
  "home.tasks.empty.projectDescription": "Start a session to begin work in this project.",
  "home.tasks.filter.all": "All tasks",
  "home.tasks.filter.pinned": "Pinned",
  "home.tasks.filter.archived": "Archived",
  "home.tasks.group.needsAction": "Needs action",
  "home.tasks.group.running": "Running",
  "home.tasks.group.recent": "Recent",
  "home.tasks.group.done": "Done",
  "home.tasks.status.needsAction": "Needs action",
  "home.tasks.status.running": "Running",
  "home.tasks.status.ready": "Ready",
  "home.tasks.status.done": "Done",
  "home.tasks.meta.permission": "Permission",
  "home.tasks.meta.question": "Question",
  "home.tasks.meta.todo": "{{done}}/{{total}} done",
  "home.tasks.detail.title": "Task detail",
  "home.tasks.detail.emptyTitle": "No task selected",
  "home.tasks.detail.emptyDescription": "Hover or focus a task to inspect its workflow state.",
  "home.tasks.detail.emptyProjectTitle": "{{project}} is ready",
  "home.tasks.detail.emptyProjectDescription": "Create the first session to turn this project into an active task.",
  "home.tasks.detail.emptyProjectPath": "Project path",
  "home.tasks.detail.status": "Status",
  "home.tasks.detail.project": "Project",
  "home.tasks.detail.updated": "Updated",
  "home.tasks.detail.progress": "Progress",
  "home.tasks.detail.noProgress": "No todo",
  "home.tasks.detail.signals": "Signals",
  "home.tasks.detail.noSignals": "No pending signals",
  "home.tasks.detail.context": "Context",
  "home.tasks.detail.directory": "Directory",
  "home.tasks.detail.session": "Session",
  "home.tasks.detail.open": "Open task",

  "session.tab.session": "Session",
  "session.tab.review": "Review",
  "session.tab.context": "Context",
  "session.workflow.title": "Session navigator",
  "session.workflow.empty": "No sessions in this directory",
  ...
  "sidebar.gettingStarted.line1": "NeCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the NeCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for NeCode",
  ...
  "settings.general.row.appearance.description": "Customise how NeCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NeCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NeCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NeCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NeCode.",
  ...
  "settings.plugins.desktopOnly": "Plugin management is available in the desktop app",
  "settings.plugins.noProject": "Open a project to manage plugins",
  ...
  "settings.plugins.source.file": "Local path",
  "settings.plugins.dialog.install.title": "Install plugin",
  "settings.plugins.dialog.install.action": "Install",
  "settings.plugins.dialog.install.method.npm": "npm package",
  "settings.plugins.dialog.install.method.local": "Local plugin",
  "settings.plugins.dialog.install.npm.label": "Package name",
  "settings.plugins.dialog.install.npm.placeholder": "For example @scope/plugin",
  "settings.plugins.dialog.install.local.path": "Selected path",
  "settings.plugins.dialog.install.local.chooseDirectory": "Choose plugin folder",
  "settings.plugins.dialog.install.local.chooseFile": "Choose entry file",
  "settings.plugins.dialog.install.scope": "Install scope",
  "settings.plugins.dialog.install.error.npm": "Enter an npm package name",
  "settings.plugins.dialog.install.error.local": "Choose a local plugin folder or entry file",
  "settings.plugins.dialog.install.error.desktop": "Local plugin selection requires the desktop app",
  "settings.plugins.dialog.remove.title": "Remove plugin",
  "settings.plugins.dialog.remove.description": "Remove {{name}} from {{scope}}?",
  "settings.plugins.dialog.remove.action": "Remove",
  "settings.plugins.detail.source": "Source",
  "settings.plugins.detail.scope": "Scope",
  "settings.plugins.detail.key": "Plugin key",
  "settings.plugins.detail.spec": "Specification",
  "settings.plugins.detail.target": "Resolved target",
  "settings.plugins.detail.errorStage": "Failure stage",
  "settings.plugins.detail.errorMessage": "Error",
  "settings.plugins.detail.capabilities": "Capabilities",
  "settings.plugins.detail.tools": "Tools",
  "settings.plugins.detail.skills": "Skills",
  ...
  "settings.mcp.scope.builtin": "Built-in",
  "settings.mcp.overridden.project": "Overridden by project configuration",
  "settings.mcp.overridden.global": "Overridden by global configuration",
  ...
  "settings.mcp.import.placeholder": "Paste one MCP server as JSON or JSONC",
  ...
  "settings.mcp.dialog.editTitle": "Edit MCP",
  "settings.mcp.dialog.remove.title": "Remove MCP",
  "settings.mcp.dialog.remove.description": 'Remove "{{name}}" from {{scope}}?',
  "settings.mcp.dialog.remove.action": "Remove",
  ...
  "settings.mcp.dialog.scope.builtin": "Built-in",
  ...
  "settings.mcp.dialog.local.argument": "Argument {{index}}",
  "settings.mcp.dialog.local.addArgument": "Add argument",
  "settings.mcp.dialog.local.removeCommand": "Remove command row {{row}}",
  "settings.mcp.dialog.local.cwd": "Working directory",
  "settings.mcp.dialog.local.cwdPlaceholder": "Optional working directory",
  "settings.mcp.dialog.local.environment": "Environment variable",
  "settings.mcp.dialog.local.environmentKey": "NAME",
  "settings.mcp.dialog.local.environmentValue": "Value",
  "settings.mcp.dialog.remote.url": "URL",
  "settings.mcp.dialog.remote.urlPlaceholder": "https://example.com/mcp",
  "settings.mcp.dialog.remote.header": "Header",
  "settings.mcp.dialog.remote.headerKey": "Header name",
  "settings.mcp.dialog.remote.headerValue": "Header value",
  "settings.mcp.dialog.oauth.label": "OAuth",
  "settings.mcp.dialog.oauth.auto": "Automatic",
  "settings.mcp.dialog.oauth.disabled": "Disabled",
  "settings.mcp.dialog.oauth.explicit": "Explicit client",
  "settings.mcp.dialog.oauth.clientId": "Client ID",
  "settings.mcp.dialog.oauth.clientSecret": "Client secret",
  "settings.mcp.dialog.oauth.scope": "Scope",
  "settings.mcp.dialog.oauth.callbackPort": "Callback port",
  "settings.mcp.dialog.oauth.redirectUri": "Redirect URI",
  "settings.mcp.dialog.keyValue.key": "{{label}} key {{row}}",
  "settings.mcp.dialog.keyValue.value": "{{label}} value {{row}}",
  "settings.mcp.dialog.keyValue.add": "Add {{label}}",
  "settings.mcp.dialog.keyValue.remove": "Remove {{label}} row {{row}}",
  "settings.mcp.dialog.typeSwitch.message": "Switching type will clear the current type fields",
  "settings.mcp.dialog.typeSwitch.cancel": "Cancel switch",
  "settings.mcp.dialog.typeSwitch.confirm": "Continue switch",
  "settings.mcp.dialog.error.required": "This field is required",
  "settings.mcp.dialog.error.reserved": "This name is reserved",
  "settings.mcp.dialog.error.duplicate": "This name already exists",
  "settings.mcp.dialog.error.invalidName": "Use lowercase letters, numbers, underscores, or hyphens",
  "settings.mcp.dialog.error.positiveInteger": "Enter a positive integer",
  "settings.mcp.dialog.error.url": "Enter an HTTP or HTTPS URL",
  "settings.mcp.dialog.error.value": "Enter a valid value",
  "settings.mcp.dialog.error.incompleteKeyValue": "Both key and value are required",
  "settings.mcp.dialog.error.duplicateKey": "Keys must be unique",
  "settings.rag.title": "Documents",
  "settings.rag.allDocuments": "All documents",
  "settings.rag.allDocumentsDescription": "Search all indexed documents",
  "settings.rag.action.files": "Import files",
  "settings.rag.action.folder": "Import folder",
  "settings.rag.action.importing": "Importing...",
  "settings.rag.dialog.chooseFiles": "Choose documents",
  "settings.rag.dialog.chooseFolder": "Choose document folder",
  "settings.rag.metric.documents": "Indexed documents",
  "settings.rag.metric.chunks": "Chunks",
  "settings.rag.section.index": "Index",
  "settings.rag.section.documents": "Indexed documents",
  "settings.rag.storePath": "Index location",
  "settings.rag.empty": "No documents indexed",
  "settings.rag.toast.imported.title": "Documents imported",
  "settings.rag.toast.imported.description": "Imported {{count}} path(s) into the local index.",
  "settings.rag.toast.desktopOnly.title": "Desktop required",
  "settings.rag.toast.desktopOnly.description": "Local document import is available in the desktop app.",
  ...
  "settings.skills.action.install": "Install skill",
  "settings.skills.action.remove": "Uninstall",
  "settings.skills.scope.local": "Current project",
  "settings.skills.scope.global": "Global",
  "settings.skills.source.builtin": "Built-in",
  "settings.skills.source.managed": "Installed",
  "settings.skills.source.plugin": "Plugin",
  "settings.skills.source.external": "External",
  "settings.skills.source.configured": "Discovered",
  "settings.skills.source.url": "URL cache",
  "settings.skills.dialog.install.title": "Install skill",
  "settings.skills.dialog.install.method.url": "GitHub / URL",
  "settings.skills.dialog.install.method.local": "Local directory",
  "settings.skills.dialog.install.url.label": "GitHub repository or Skill feed URL",
  "settings.skills.dialog.install.url.placeholder": "https://github.com/owner/repository",
  "settings.skills.dialog.install.local.label": "Skill directory",
  "settings.skills.dialog.install.local.placeholder": "Select or enter a local directory",
  "settings.skills.dialog.install.local.choose": "Choose",
  "settings.skills.dialog.install.scope": "Install scope",
  "settings.skills.dialog.install.action": "Install",
  "settings.skills.dialog.install.installing": "Installing…",
  "settings.skills.dialog.install.progress": "Downloading and installing. Larger repositories may take a while.",
  "settings.skills.toast.installed.title": "Skills installed",
  "settings.skills.toast.installed.description": "Installed {{count}} skills and placed them at the top of the list.",
  "settings.skills.toast.installed.unchanged": "The skills are already up to date. The list has been refreshed.",
  "settings.skills.section.recent": "Just installed ({{count}})",
  "settings.skills.section.other": "Other skills",
  "settings.skills.dialog.install.replace": "Confirm replacement",
  "settings.skills.dialog.install.conflict":
    "{{name}} is installed from {{source}}. Confirm to replace it with the new source.",
  "settings.skills.dialog.install.error.url": "Enter a GitHub repository or Skill feed URL",
  "settings.skills.dialog.install.error.local": "Select or enter a Skill directory",
  "settings.skills.dialog.install.error.desktop": "The directory picker is available in NeCode Desktop",
  "settings.skills.dialog.remove.title": "Uninstall skill",
  "settings.skills.dialog.remove.description":
    "Remove the independently installed Skill “{{name}}”? Plugin-provided and discovered Skills cannot be removed here.",
  ...
  "session.action.restore": "Restore session",
