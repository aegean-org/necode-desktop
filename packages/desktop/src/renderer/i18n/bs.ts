export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju NeCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} NeCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
