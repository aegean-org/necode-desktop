export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af NeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af NeCode er blevet downloadet. Vil du installere den og genstarte?",
