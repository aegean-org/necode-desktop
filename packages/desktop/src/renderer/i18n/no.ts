export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av NeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av NeCode er lastet ned. Vil du installere den og starte på nytt?",
