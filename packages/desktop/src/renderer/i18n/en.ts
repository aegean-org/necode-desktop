export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of NeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of NeCode has been downloaded, would you like to install it and relaunch?",
