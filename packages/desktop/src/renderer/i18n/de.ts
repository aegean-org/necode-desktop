export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von NeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von NeCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
