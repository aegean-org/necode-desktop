export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'NeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'NeCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
